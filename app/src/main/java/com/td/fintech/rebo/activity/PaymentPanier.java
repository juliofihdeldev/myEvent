...
public class PaymentPanier extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Payer");
        ...
        tvPrice.setText( prix +  "HTG ");
        btnpayment.setText( " Payer " + prix +  " HTG ");
   ...
   public void goToMyCommande(){
        Intent goCommande = new Intent(getApplicationContext(), Commande_Activity.class);
        startActivity(goCommande);
   }
    ...
    public void doPayment (){
        ...
        final String carteNumber = "4242424242424242" ;
        //tvCarteNumber.getText().toString(); //"4242424242424242"
